function plotRobotArm(roll, pitch, yaw, armLength, fig_color, x_lim, y_lim, z_lim)
    ...
    for i = 1:3
        ...
        Rx = [1 0 0; 0 cosd(roll(i)) -sind(roll(i));...
            0 sind(roll(i)) cosd(roll(i))];
        Ry = [cosd(pitch(i)) 0 sind(pitch(i));...
            0 1 0; -sind(pitch(i)) 0 cosd(pitch(i))];
        Rz = [cosd(yaw(i)) -sind(yaw(i)) 0;...
            sind(yaw(i)) cosd(yaw(i)) 0; 0 0 1];
        ...
        x = endpoint(1); y = endpoint(2); z = endpoint(3);
    end
